...
Los visitantes guardan nombre, tipo de documento, documento, pais, ciudad y servicio como datos obligatorios; tipo de visitante usa `General` por defecto y email/telefono son opcionales en `museum_visitors`.
